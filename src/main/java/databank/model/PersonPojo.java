 ...
 * TODO 17 - make PersonPojoListener be the lister of this class. use: done
 ...
 * TODO 20 - dates (which are LocalDateTime) should be mapped while editable is not to be mapped  done
 */
@Entity( name = "Person")
...
public class PersonPojo implements Serializable {
	...
	// ?? location of the annotation needs to confirm with prof
	@Id
